...
//
// All real environments IDs are greater than 0 (so the sign bit is zero).
// envid_t values less than 0 signify errors.  The envid_t == 0 is special, and
